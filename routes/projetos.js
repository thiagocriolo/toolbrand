...
//     try {
//         // Busca o usuário pelo id_usuario
...
//         // Busca o projeto pelo id_projeto
...
//         // Log do cliente_responsavel
//         console.log(`Cliente responsável: ${projeto.cliente_responsavel}`);

//         // Busca o cliente responsável pelo nome
//         const resgataCliente = await User.findOne({ where: { nome: projeto.cliente_responsavel } });
...
//         // Verifica se existe uma entrada na tabela UsuarioDoProjeto para o líder do projeto
//         let usuarioProjetoLider = await UsuarioDoProjeto.findOne({
//             where: { id_usuario, id_projeto }
//         });

//         if (!usuarioProjetoLider) {
//             // Se não existir, cria uma nova entrada para o líder do projeto
...
//         // Verifica se existe uma entrada na tabela UsuarioDoProjeto para o cliente responsável
...
//             // Se não existir, cria uma nova entrada para o cliente responsável
...
//         // Busca todos os usuários cujo ID não é igual ao id_usuario
